...
import GraficoTemperatura from './graficotemperatura.js';
...
function Temperatura() {
  ...
  const obterMedicoesPorData = async (dataStr) => {
    const q = query(collection(db, "medicoes"), where("data", "==", dataStr));
  ...
  return (
    <div className="container">
      <h1 className="header">Registrar Medição Temperatura</h1>
